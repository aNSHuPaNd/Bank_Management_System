    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            if (r1.isSelected()) {
                ...
                accType = "Fixed Depoit Account";
            } else if (r3.isSelected()) {
                accType = "Current Account";
            } else if (r4.isSelected()) {
                accType = "Recurring Depoit Account";
            }

            Random rn = new Random();
            String cardNo = "" + Math.abs((rn.nextLong() % 90000000L) + 5040936000000000L);
            String pinNo = "" + Math.abs((rn.nextLong() % 9000L) + 1000L);
            ...
            try {
                if (accType.equals("")) {
                    ...
                    Conn conn = new Conn();
                    String query1 = "insert into signupthree values('" + accType + "', '" + cardNo + "', '" + pinNo + "', '" + facility + "')";
